...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [(config('REDIS_HOST', cast=str), config('REDIS_PORT', cast=int)),],  # Redis connection for local development
        },
    },
}
...
# Setting of Default authentication for rest_framework
REST_FRAMEWORK = {
...
# Basic configuration for simple_jwt 
SIMPLE_JWT = {
